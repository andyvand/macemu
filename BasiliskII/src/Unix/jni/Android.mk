...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/include $(LOCAL_PATH)/../uae_cpu_2021 $(LOCAL_PATH)/../include /Users/andyvand/Library/Android/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/include/SDL2
LOCAL_CFLAGS := -I$(LOCAL_PATH)/../include -I/Users/andyvand/Library/Android/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/include/SDL2 -I $(LOCAL_PATH)/../uae_cpu_2021 -fexceptions -frtti -DGUICHAN_GUI -DANDROIDSDL -D_REENTRANT -DDIRECT_ADDRESSING -DUAE -Dfptype=uae_f64 -DSTATIC_INLINE="static inline" -DTCHAR=char -DCPU_64_BIT=1
LOCAL_LDLIBS :=
